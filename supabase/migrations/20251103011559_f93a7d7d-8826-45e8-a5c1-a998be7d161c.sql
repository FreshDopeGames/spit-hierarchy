-- Add vs_visits column to member_stats
ALTER TABLE public.member_stats 
ADD COLUMN IF NOT EXISTS vs_visits INTEGER DEFAULT 0;

-- Update increment_page_visit_stat to handle vs_visits
...
-- Update check_and_award_achievements to include vs_visits
