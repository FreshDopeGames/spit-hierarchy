-- Drop and recreate get_album_with_tracks to include external_cover_links
...
AS $$
  ...
  GROUP BY a.id, a.title, a.slug, a.release_date, a.release_type, a.cover_art_url, a.track_count, a.external_cover_links;
$$;