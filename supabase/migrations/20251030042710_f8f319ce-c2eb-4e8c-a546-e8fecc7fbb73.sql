-- Re-clean the decade rankings now that career_start_year is correct
DO $$
DECLARE
  ranking_80s UUID := 'f43cde5f-9930-4456-8e45-b023aafa3223';
  ranking_90s UUID := '83c9c3d8-6c54-44f6-9e74-6f05c5e8b0dc';
BEGIN
  RAISE NOTICE 'Re-cleaning Top 80s Rappers';
  ...
  RAISE NOTICE 'Re-cleaning Top 90s Rappers';
  PERFORM clean_official_ranking_items(
    ranking_90s,
...
SELECT 
  'Top 80s Rappers - Total Count' as check_name,
  COUNT(*) as invalid_count
FROM ranking_items
WHERE ranking_id = 'f43cde5f-9930-4456-8e45-b023aafa3223'
...
SELECT 
  'Top 90s Rappers - Total Count' as check_name,
  COUNT(*) as invalid_count
FROM ranking_items
WHERE ranking_id = '83c9c3d8-6c54-44f6-9e74-6f05c5e8b0dc';