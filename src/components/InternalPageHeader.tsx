...
const InternalPageHeader = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-rap-carbon/95 backdrop-blur-md border-b border-rap-gold/50 py-3">
          ...
          <div className="flex items-center justify-center flex-1">
            {showTitle ? (
              <div className="flex items-center space-x-3">
                <img src="/lovable-uploads/eea1a328-61f1-40e8-bdac-06d4e50baefe.png" alt="Spit Hierarchy Logo" className="w-10 h-8 object-contain" />
                <div>
              ...
              <img src="/lovable-uploads/eea1a328-61f1-40e8-bdac-06d4e50baefe.png" alt="Spit Hierarchy Logo" className="h-12 object-contain" />
            )}
          </div>
        </div>
