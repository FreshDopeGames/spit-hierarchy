        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center space-x-3">
            <img 
              ...
              className="w-10 h-8 object-contain animate-glow-pulse"
            />
            <div>
              <h1 className="text-2xl font-mogra text-rap-gold animate-text-glow">{title}</h1>
              {subtitle && (
                <p className="text-rap-gold/70 font-kaushan text-sm tracking-wider">{subtitle}</p>
              )}
            </div>
          </div>
        </div>
