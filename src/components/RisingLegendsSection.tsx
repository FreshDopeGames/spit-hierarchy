    ...
    <div className="mb-12">
      ...
      <div className="text-center mt-8">
        <Link to="/rankings/official/rising-legends-2024">
          <Button 
            className="bg-gradient-to-r from-rap-forest to-rap-forest-light hover:from-rap-forest-light hover:to-rap-forest font-mogra shadow-xl shadow-rap-forest/40 border border-rap-forest/30"
            size="lg"
          >
