      ...
      <main className="max-w-4xl mx-auto p-6 pt-24">
        <Card className="bg-[var(--theme-surface)] border border-[var(--theme-border)]">
          <CardContent className="p-8 text-center">
            <h1 className="text-2xl font-[var(--theme-fontPrimary)] text-[var(--theme-primary)] mb-4">Slick Talk Not Found</h1>
            <p className="text-[var(--theme-text)] mb-6">This post may have been lost to the winds of time.</p>
            <Link to="/blog" className="text-[var(--theme-primary)] hover:text-[var(--theme-primary)]/80">
              Return to Slick Talk
            </Link>
          </CardContent>
        </Card>
      </main>
