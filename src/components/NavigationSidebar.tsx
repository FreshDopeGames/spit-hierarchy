...
import { Menu, Home, Trophy, Music, Swords, PenTool, BookOpen, Info, BarChart3, Settings, LogOut, Shield, FileText, Instagram } from "lucide-react";
...
const NavigationSidebar = ({
  ...
  return <Sheet open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <SheetContent side="left" className="w-80 bg-[var(--theme-surface)] border-r-2 border-[var(--theme-border)] p-0 overflow-y-auto">
        <div className="flex flex-col h-full">
          {/* Header */}
          <SheetHeader className="px-6 py-1 text-center">
            <div className="flex justify-center">
              <img src="/lovable-uploads/eea1a328-61f1-40e8-bdac-06d4e50baefe.png" alt="Spit Hierarchy Logo" className="h-14 w-auto" />
            </div>
          </SheetHeader>
          
          {/* User Profile Section */}
          {user && userProfile && <div className="px-6 py-3">
          ...
          <nav className="flex-1 p-6">
            ...
            <a 
              href="https://www.instagram.com/spithierarchy?igsh=MzRlODBiNWFlZA=="
              target="_blank"
            ...
            <a 
              href="https://discord.gg/aTvt6XbAk"
              target="_blank"
              rel="noopener noreferrer"
            >
              <ThemedButton 
