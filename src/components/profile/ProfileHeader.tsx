...
const ProfileHeader = ({ user, profile, memberStats }: ProfileHeaderProps) => {
  ...
  return (
    <div className="bg-[var(--theme-surface)] border border-[var(--theme-primary)]/30 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8 shadow-lg shadow-[var(--theme-primary)]/20">
        ...
        <div className="flex-1 text-center lg:text-left w-full">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-10">
            ...
            <div className="flex-1 lg:flex-shrink">
              ...
              {profile?.bio && (
                <p className="text-[var(--theme-text)] mb-4 font-[var(--theme-fontSecondary)] text-sm sm:text-base">
                  {profile.bio}
                </p>
              )}
            ...
            {memberStats && (
              <div className="flex-shrink-0 text-center lg:text-right lg:min-w-72">
                ...
                {currentStatus === 'diamond' && (
                  <div className="text-xs text-[var(--theme-accent)] font-[var(--theme-fontSecondary)] font-bold mt-2">
