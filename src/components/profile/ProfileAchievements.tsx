        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            ...
            <Link to="/analytics?tab=achievements">
              <Button variant="outline" size="sm" className="border-[var(--theme-primary)]/30 text-[var(--theme-primary)] hover:bg-[var(--theme-primary)] hover:text-[var(--theme-background)] w-full sm:w-auto text-xs sm:text-sm">
      ...
      <CardContent>
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-[var(--theme-background)] border border-[var(--theme-primary)]/30 mb-4">
            <TabsTrigger value="overview" className="data-[state=active]:bg-[var(--theme-primary)] data-[state=active]:text-[var(--theme-background)] text-[var(--theme-text)] text-xs sm:text-sm">
              <LayoutGrid className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
              Recent
            </TabsTrigger>
            <TabsTrigger value="table" className="data-[state=active]:bg-[var(--theme-primary)] data-[state=active]:text-[var(--theme-background)] text-[var(--theme-text)] text-xs sm:text-sm">
          ...
          <TabsContent value="table">
            <div className="space-y-4">
              ...
              <div className="text-center">
                <Link to="/analytics?tab=achievements">
                  <Button variant="outline" className="border-[var(--theme-primary)]/30 text-[var(--theme-primary)] hover:bg-[var(--theme-primary)] hover:text-[var(--theme-background)]">
                    View All Achievements
                  </Button>
                </Link>
              </div>
