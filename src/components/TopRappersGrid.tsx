    ...
    <div className="mb-12">
      ...
      <div className="text-center mt-8">
        <Link to="/rankings/official/goat-top-5">
          <Button 
            className="bg-gradient-to-r from-rap-gold to-rap-gold-light hover:from-rap-gold-light hover:to-rap-gold font-mogra shadow-xl shadow-rap-gold/40 border border-rap-gold/30"
            size="lg"
          >
