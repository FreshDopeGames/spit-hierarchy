    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="h-32 bg-carbon-fiber/50 rounded-lg animate-pulse" />
        ))}
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-carbon-fiber/90 border border-rap-gold/30 rounded-lg p-4 text-center">
      ...
      <Tabs defaultValue="all" className="w-full">
        <TabsList className="grid w-full grid-cols-4 md:grid-cols-7 bg-carbon-fiber border border-rap-gold/30">
