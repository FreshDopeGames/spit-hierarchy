        ...
        <CardContent>
          <Tabs value={selectedZodiac} onValueChange={setSelectedZodiac} className="w-full">
            <TabsList className="grid grid-cols-4 lg:grid-cols-7 gap-1 bg-carbon-fiber border border-rap-gold/40 h-auto p-2">
              <TabsTrigger 
                value="all" 
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-rap-burgundy data-[state=active]:to-rap-forest data-[state=active]:text-rap-platinum text-xs font-kaushan"
              >
                All Signs
              </TabsTrigger>
              {zodiacSigns.slice(0, 6).map((sign) => (
                <TabsTrigger 
                  key={sign.name}
                  value={sign.name}
                  className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-rap-burgundy data-[state=active]:to-rap-forest data-[state=active]:text-rap-platinum text-xs flex items-center gap-1 font-kaushan"
                >
            ...
            <div className="mt-4 grid grid-cols-2 lg:grid-cols-6 gap-2">
              {zodiacSigns.slice(6).map((sign) => (
                <button
                  ...
                  className={`p-2 rounded-lg border text-xs flex items-center gap-1 justify-center transition-colors font-kaushan ${
                    selectedZodiac === sign.name 
                      ? 'bg-gradient-to-r from-rap-burgundy to-rap-forest text-rap-platinum border-rap-gold' 
