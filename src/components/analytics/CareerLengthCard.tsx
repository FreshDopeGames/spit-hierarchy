          ...
          {careerStats && (careerStats.activeArtistsCount > 0 || careerStats.deceasedArtistsCount > 0) && (
            <div className="grid grid-cols-3 gap-2 pt-3 border-t border-rap-gold/20">
              <div className="text-center">
                ...
                <div className="text-xs font-bold text-rap-platinum">{careerStats.activeArtistsCount}</div>
                <div className="text-xs text-rap-smoke">Active</div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 text-rap-smoke mb-1">
                  <Pause className="w-3 h-3" />
                </div>
                <div className="text-xs font-bold text-rap-platinum">{careerStats.completedCareersCount}</div>
                <div className="text-xs text-rap-smoke">Inactive</div>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 text-gray-400 mb-1">
                  <Skull className="w-3 h-3" />
                </div>
                <div className="text-xs font-bold text-rap-platinum">{careerStats.deceasedArtistsCount}</div>
                <div className="text-xs text-rap-smoke">Deceased</div>
              </div>
            </div>
          )}
        </div>
