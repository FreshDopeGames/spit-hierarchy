...
const RecentActivityCard = () => {
  ...
  if (isLoading) {
    return <Card className="bg-carbon-fiber/90 border-2 border-rap-gold shadow-lg shadow-rap-gold/20 animate-pulse">
  ...
  return <Card className="bg-carbon-fiber/90 border-2 border-rap-gold shadow-lg shadow-rap-gold/20">
      <CardHeader>
      ...
      <CardContent>
        <div className="space-y-2">
          {recentActivity.slice(0, 5).map((vote: any) => <div key={vote.id} className="flex items-center justify-between p-2 text-sm">
              <div className="flex-1">
                <span className="text-rap-platinum font-kaushan text-2xl">
                  {vote.rappers?.name}
                </span>
