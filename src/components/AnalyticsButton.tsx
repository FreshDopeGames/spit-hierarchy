...
const AnalyticsButton = () => {
  ...
  return <div className="text-center mt-4 mb-12">
      {user ? <Link to="/analytics" onClick={handleAnalyticsClick}>
          ...
          <Button size="lg" className="bg-[hsl(var(--theme-secondary))] hover:bg-[hsl(var(--theme-secondaryLight))] text-[hsl(var(--theme-background))] font-[var(--theme-font-heading)] text-lg shadow-xl shadow-[hsl(var(--theme-secondary))]/40 border-2 border-black ">
            <BarChart3 className="w-5 h-5 mr-2" />
