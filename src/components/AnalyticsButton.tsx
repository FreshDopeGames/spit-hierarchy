...
const AnalyticsButton = () => {
  ...
  return <div className="text-center mt-4 mb-12">
      {user ? <Link to="/analytics" onClick={handleAnalyticsClick}>
          <Button size="lg" className="font-[var(--theme-font-heading)] text-lg shadow-xl shadow-[hsl(var(--theme-primary))]/40 border border-[hsl(var(--theme-primary))]/30 bg-[hsl(var(--theme-primary))] font-extrabold hover:bg-[hsl(var(--theme-primaryLight))] hover:text-[hsl(var(--theme-primaryDark))] text-[hsl(var(--theme-background))]">
