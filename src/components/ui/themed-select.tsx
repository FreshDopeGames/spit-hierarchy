...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-[var(--theme-element-dropdown-border-radius,var(--theme-radius-md))] border border-[var(--theme-element-dropdown-border-color,var(--theme-border))] shadow-[var(--theme-element-dropdown-shadow,0_10px_15px_rgba(212,175,55,0.2))] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        position === "popper" &&
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-1.5 pl-8 pr-2 text-sm font-semibold text-[var(--theme-element-select-color,var(--theme-text))] font-[var(--theme-font-heading)]", className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm text-[var(--theme-element-select-color,var(--theme-text))] outline-none focus:bg-[var(--theme-primary)] focus:text-[var(--theme-background)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 font-[var(--theme-element-select-fontFamily,var(--theme-font-body))]",
      className
    )}
    {...props}
  >
