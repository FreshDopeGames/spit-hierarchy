...
const VSMatchCommentsSection = ({ vsMatchId, title }: VSMatchCommentsSectionProps) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-16">
      ...
      {/* Comments Section */}
      <div className="border-4 border-[var(--theme-primary)] rounded-lg shadow-2xl shadow-[var(--theme-primary)]/20 p-6" style={{ 
          ...
          <div className="bg-[var(--theme-background)]/50 border border-[var(--theme-primary)]/30 rounded-lg p-4 mb-6">
            ...
            <div className="flex justify-between items-center mt-3">
              <ThemedButton
                ...
                className="bg-[hsl(var(--theme-primary))] text-black hover:bg-[hsl(var(--theme-primaryLight))] font-mogra disabled:opacity-50"
              >
