    ...
    <Card className="bg-carbon-fiber border-rap-silver/40 shadow-2xl shadow-rap-silver/20">
      ...
      <CardContent className="space-y-4">
        {rappers.map((rapper, index) => {
          ...
          return (
            <div key={rapper.id} className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-3 sm:p-4 bg-rap-carbon/30 rounded-lg hover:bg-rap-carbon/50 transition-colors relative">
