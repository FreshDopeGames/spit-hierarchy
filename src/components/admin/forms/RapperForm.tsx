  ...
  const saveRapperMutation = useMutation({
    mutationFn: async (data: RapperFormData) => {
      const rapperData = {
        ...
        birth_month: data.birth_month && data.birth_month !== "none" ? parseInt(data.birth_month) : null,
        birth_day: data.birth_day && data.birth_day !== "none" ? parseInt(data.birth_day) : null,
        bio: data.bio || null,
