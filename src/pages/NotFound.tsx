...
const NotFound = () => {
  ...
  return (
    <>
      <SEOHead
        title="Page Not Found - Spit Hierarchy"
        description="The page you're looking for doesn't exist. Return to the homepage to explore rapper rankings and hip-hop culture."
