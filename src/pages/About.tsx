      ...
      <div className="pt-20 max-w-4xl mx-auto p-6 space-y-8">
        ...
        <Card className="bg-carbon-fiber border-rap-gold/50">
          <CardHeader>
            <CardTitle className="text-rap-silver font-ceviche text-2xl flex items-center">
              <Music className="w-6 h-6 mr-3 text-rap-forest-light" />
              What We Do
            </CardTitle>
          </CardHeader>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-carbon-fiber border-rap-gold/50">
            <CardHeader>
              <CardTitle className="text-rap-silver font-mogra flex items-center">
                <Vote className="w-5 h-5 mr-3 text-rap-forest-light" />
                Vote & Rank
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-carbon-fiber border-rap-gold/50">
            <CardHeader>
              <CardTitle className="text-rap-silver font-mogra flex items-center">
                <Trophy className="w-5 h-5 mr-3 text-rap-forest-light" />
                Real Rankings
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-carbon-fiber border-rap-gold/50">
            <CardHeader>
              <CardTitle className="text-rap-silver font-mogra flex items-center">
                <Users className="w-5 h-5 mr-3 text-rap-forest-light" />
                Community Driven
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-carbon-fiber border-rap-gold/50">
            <CardHeader>
              <CardTitle className="text-rap-silver font-mogra flex items-center">
                <BarChart3 className="w-5 h-5 mr-3 text-rap-forest-light" />
                Deep Analytics
              </CardTitle>
            </CardHeader>
            <CardContent>
