  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Test your rap knowledge with our interactive quiz! Answer questions about rappers, albums, and hip-hop history to earn badges and prove your expertise."
        />
      </Helmet>
        ...
        <div className="relative z-10 max-w-4xl mx-auto p-6 pt-28 pb-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Put your hip-hop knowledge to the test. Answer questions about your favorite rappers, their albums,
              origins, and career milestones. Earn badges and climb the ranks!
            </p>
          </div>
