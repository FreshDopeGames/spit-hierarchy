...
const AllRappers = () => {
  ...
  if (isLoading && currentPage === 0) {
    return <div className="min-h-screen bg-gradient-to-br from-rap-carbon via-rap-carbon-light to-rap-carbon">
        <InternalPageHeader title="All Artists" subtitle="Loading the culture..." />
  ...
  return <div className="min-h-screen bg-gradient-to-br from-rap-carbon via-rap-carbon-light to-rap-carbon">
      <InternalPageHeader title="The Lyricist Collective" subtitle={`${total} wordsmith legends • Showcasing ${allRappers.length}`} />
      ...
      <div className="pt-20 max-w-7xl mx-auto p-6">
        ...
        {/* Filters and Search */}
        <AllRappersFilters searchInput={searchInput} searchTerm={searchTerm} locationFilter={locationFilter} sortBy={sortBy} sortOrder={sortOrder} onSearchInput={handleSearchInput} onLocationFilter={handleLocationFilter} onSortChange={handleSortChange} onOrderChange={handleOrderChange} />
