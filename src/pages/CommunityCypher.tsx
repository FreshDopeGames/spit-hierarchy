      ...
      <div className="max-w-4xl mx-auto pt-20 px-4 pb-8">
        ...
        <div className="text-center mb-8">
          ...
          {!user && <div className="mb-8">
              <Link to="/auth">
                <ThemedButton className="bg-gradient-to-r from-[hsl(var(--theme-primary))] via-[hsl(var(--theme-primaryLight))] to-[hsl(var(--theme-primary))] hover:opacity-90 text-black font-mogra text-lg px-8 py-3 border-2 border-black shadow-[0_8px_16px_rgba(0,0,0,0.4)]">
