...
const officialRankings = [{
  ...
  rappers: [{
    rank: 1,
    name: "Nas",
    reason: "Illmatic changed everything"
  }, {
    rank: 2,
    name: "Jay-Z",
    reason: "Blueprint for success"
  }, {
    rank: 3,
    name: "The Notorious B.I.G.",
    reason: "Storytelling legend"
  }, {
    rank: 4,
    name: "Tupac Shakur",
    reason: "Voice of a generation"
  }, {
    rank: 5,
    name: "Eminem",
    reason: "Technical virtuoso"
  }],
  likes: 892,
  comments: 234,
  views: 5240,
  ...
  rappers: [{
    rank: 1,
    name: "Doechii",
    reason: "Breakthrough versatility"
  }, {
    rank: 2,
    name: "Lil Yachty",
    reason: "Artistic evolution"
  }, {
    rank: 3,
    name: "Ice Spice",
    reason: "Cultural impact"
  }, {
    rank: 4,
    name: "Central Cee",
    reason: "Global crossover appeal"
  }, {
    rank: 5,
    name: "Sexyy Red",
    reason: "Authentic street energy"
  }],
  likes: 445,
  comments: 89,
  views: 2890,
  ...
  rappers: [{
    rank: 1,
    name: "MF DOOM",
    reason: "Unmatched wordplay complexity"
  }, {
    rank: 2,
    name: "Kendrick Lamar",
    reason: "Modern poetry master"
  }, {
    rank: 3,
    name: "Black Thought",
    reason: "Consistent lyrical excellence"
  }, {
    rank: 4,
    name: "Andre 3000",
    reason: "Creative linguistic genius"
  }, {
    rank: 5,
    name: "Lupe Fiasco",
    reason: "Multi-layered storytelling"
  }],
  likes: 623,
  comments: 156,
  views: 3420,
  ...
  rappers: [{
    rank: 1,
    name: "Nas",
    reason: "Illmatic - Genre-defining masterpiece"
  }, {
    rank: 2,
    name: "Dr. Dre",
    reason: "The Chronic - West Coast blueprint"
  }, {
    rank: 3,
    name: "Wu-Tang Clan",
    reason: "Enter the Wu-Tang - Raw innovation"
  }, {
    rank: 4,
    name: "Public Enemy",
    reason: "It Takes a Nation - Political awakening"
  }, {
    rank: 5,
    name: "OutKast",
    reason: "ATLiens - Southern hip-hop revolution"
  }],
  likes: 789,
  comments: 201,
  views: 4560,
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <header className="bg-black/40 border-b border-purple-500/20 p-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <Link to="/rankings">
            <Button variant="ghost" className="bg-[rap-gold-light] bg-rap-gold text-black font-mogra text-base">
      ...
      <main className="max-w-6xl mx-auto p-6">
        <RankingHeader title="Official Rankings" description="Curated rankings created by our expert editorial team, featuring the most comprehensive and authoritative lists in hip-hop." />

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {officialRankings.map(ranking => <RankingCard key={ranking.id} {...ranking} onClick={setSelectedRanking} />)}
        </div>
      </main>
    </div>;
};
