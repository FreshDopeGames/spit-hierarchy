        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-8 mb-12">
              {/* Rapper 1 */}
              <Card className="border-4 border-[var(--theme-primary)] shadow-2xl shadow-[var(--theme-primary)]/30 w-full lg:flex-1" style={{
              ...
              <div className="flex justify-center items-center lg:flex-shrink-0">
                <div className="bg-[var(--theme-backgroundLight)] rounded-full p-4 border-4 border-[var(--theme-primary)] shadow-lg">
                  <Swords className="w-8 h-8 text-[var(--theme-primary)] rotate-90 lg:rotate-0" />
                </div>
              </div>
