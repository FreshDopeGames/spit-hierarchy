...
|---------|-----------|-------|
| Official Album Reviews in Blog Posts | 2026-08-04 | album_reviews + album_review_scores, MusicBrainz search/import edge functions, blog score card, album detail editorial score |
